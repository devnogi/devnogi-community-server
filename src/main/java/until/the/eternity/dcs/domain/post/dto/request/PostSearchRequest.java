...
public record PostSearchRequest(
        ...
        @Schema(description = "정렬 기준", example = "createdAt") String sortBy,
        @Schema(description = "정렬 방향", example = "desc") String direction
    ...
    public String resolvedDirection() {
        return (direction == null || direction.isBlank()) ? DEFAULT_DIRECTION : direction;
    }
}
